	...
	<form:form action="${addAction}" commandName="person">
		<table>
			...
			<tr>
				...
				<td><form:input id="name"
						onblur="this.value=this.value.toUpperCase()" path="name" placeHolder="Full Name"/></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><form:input path="salary" id="salary" placeHolder="salary" /></td>
			</tr>
